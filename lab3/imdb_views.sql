...
CREATE MATERIALIZED VIEW v_directors_with_20_plus_movies AS
...
CREATE MATERIALIZED VIEW v_amazing_years AS
...
/* what TV show has the most episodes (including all seasons) (need M-view)*/
CREATE MATERIALIZED VIEW v_TV_shows_with_the_most_episodes AS
...
CREATE VIEW v_average_rating_by_genre AS
...
CREATE VIEW v_year_avg_votes_after_2000 AS
...
CREATE MATERIALIZED VIEW v_num_titles_by_genre AS
select genre, count(*)
